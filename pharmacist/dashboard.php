...
<head>
  ...
  <title>
   Halton Pharmacy Management System - Pharmacist Dashboard
  </title>
...
$todysale+=$todays_sale;
 ...
 ?>
                    <div class="col">
                      ...
                      <span class="h2 font-weight-bold mb-0">Ksh. <?php echo $todysale;?></span>
                    </div>
                    <div class="col-auto">
...
$yesterdaysale+=$yesterdays_sale;
 ...
 ?>
                    <div class="col">
                      ...
                      <span class="h2 font-weight-bold mb-0">Ksh. <?php echo $yesterdaysale;?></span>
                    </div>
                    <div class="col-auto">
...
$tseven+=$sevendays_sale;
 ...
 ?>
                    <div class="col">
                      ...
                      <span class="h2 font-weight-bold mb-0">Ksh. <?php echo $tseven;?></span>
                    </div>
                    <div class="col-auto">
...
$totalsale+=$total_sale;
 ...
 ?>
                    <div class="col">
                      ...
                      <span class="h2 font-weight-bold mb-0">Ksh. <?php echo $totalsale;?></span>
                    </div>
                    <div class="col-auto">
                      <div class="icon icon-shape bg-warning text-white rounded-circle shadow">
                        <i class="fas fa-chart-pie"></i>
