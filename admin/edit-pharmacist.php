...
<head>
  ...
  <title>
     Halton Pharmacy Management System - Update Pharmacist
  </title>
                    ...
                    <div class="col-lg-12">
                     ...
                     <div class="col-lg-12">
                      <div class="form-group">
                        ...
                        <input type="text" id="username" name="username" class="form-control form-control-alternative" value="<?php  echo $row['UserName'];?>" required="true" style="border:1px #000 solid;">
                      </div>
                    </div>
...
<?php } ?>
                    ...
                    <div class="col-lg-12">
                      <div class="form-group">
                        ...
                        <input  id="" name="" type="text" class="form-control form-control-alternative" value="<?php  echo $row['JoingDate'];?>" required="true"  style="border:1px #000 solid;">
                      </div>
                    </div>
