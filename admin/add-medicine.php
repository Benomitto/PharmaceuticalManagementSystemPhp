...
<head>
  ...
  <title>
     Halton Pharmacy Management System - Add Medicine
  </title>
                  ...
                  <div class="row">
                    <div class="col-lg-12">
                      <div class="form-group">
                        <label class="form-control-label" for="input-username">Medicine Supplier</label>
                        <select class="form-control m-bot15" name="compname" id="compname" style="border:1px #000 solid;">
                                <option value="">Choose Medicine Supplier</option>
